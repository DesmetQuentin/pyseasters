...
#. :mod:`~seastersdb.data_curation`: The scripts that serve for
   :ref:`constructing the database <replicate>`.


.. note::

    Importing :mod:`seastersdb` does not import the :mod:`~seastersdb.data_curation`
    ...
    :mod:`~seastersdb.data_curation` subpackage by importing specifically
    :mod:`seastersdb.data_curation`.
"""
