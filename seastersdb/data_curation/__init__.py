"""
Provide core functions dedicated to data curation, all used in SEASTERSdb' CLI.

.. important::

   Dependencies for this subpackage of SEASTERSdb are labelled ``cli``. They can be
   installed using:
   ...
   in the SEASTERSdb directory (where ``pyproject.toml`` is located).
